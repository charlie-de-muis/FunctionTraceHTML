...
# --- CONFIG ---
PROJECT_PATH = os.path.dirname(os.path.abspath(__file__))  # your project folder
LOG_FILE = os.path.join(PROJECT_PATH, "function_trace.html")
# -------------
...
# Initializing the HTML log file
...
def _trace_calls(frame, event, arg):
    ...
    file_html = f"<span style='color:dodgerblue'>{os.path.basename(filename)}:{lineno}</span>"
    # -------------
